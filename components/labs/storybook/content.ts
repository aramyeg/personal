...
const CH1_LAYERS: readonly SceneLayer[] = [
  ...
  { id: 'ch1-stable', kind: 'backdrop', mech: 'parallel', glueL: 0.261, glueR: 0.154, rise: 0.09, z0: 0.32, z1: 0.56 },
  { id: 'ch1-wall', kind: 'foreground', mech: 'vfold', apexZ: 0.6, vDir: 1, phiDeg: 84, rhoDeg: 88, width: 1.25, height: 0.2 },
]
...
const CH3_LAYERS: readonly SceneLayer[] = [
  { id: 'ch3-towers', kind: 'backdrop', mech: 'vfold', apexZ: -0.38, vDir: -1, phiDeg: 84, rhoDeg: 88, skewDeg: 1.5, creaseU: 0.34, width: 1.5, height: 0.84 },
  ...
  { id: 'ch3-balcony', kind: 'foreground', mech: 'child', parentId: 'ch3-towers', mount: 0.44, vDir: 1, phiDeg: 52, rhoDeg: 78, width: 0.3, height: 0.36 },
  { id: 'ch3-raven-a', kind: 'hero', mech: 'child', parentId: 'ch3-towers', mount: 0.76, vDir: 1, phiDeg: 62, rhoDeg: 84, width: 0.2, height: 0.113 },
  { id: 'ch3-rank', kind: 'midground', mech: 'vfold', apexZ: -0.06, vDir: -1, phiDeg: 84, rhoDeg: 88.5, skewDeg: -1.5, creaseU: 0.64, width: 1.3, height: 0.67 },
  { id: 'ch3-raven-b', kind: 'hero', mech: 'child', parentId: 'ch3-rank', mount: 0.34, vDir: 1, phiDeg: 66, rhoDeg: 86, width: 0.11, height: 0.245 },
  { id: 'ch3-counter', kind: 'backdrop', mech: 'parallel', glueL: 0.25, glueR: 0.41, rise: 0.1, z0: 0.26, z1: 0.66 },
]
...
const CH4_LAYERS: readonly SceneLayer[] = [
  ...
  { id: 'ch4-coins', kind: 'hero', mech: 'child', parentId: 'ch4-hero', mount: 0.22, vDir: -1, phiDeg: 60, rhoDeg: 83, width: 0.24, height: 0.24 },
...
export const TITLE_LAYERS: readonly SceneLayer[] = [
  ...
  { id: 'title-hero', kind: 'hero', mech: 'vfold', apexZ: 0.15, vDir: 1, phiDeg: 52, rhoDeg: 80, width: 0.38, height: 0.63 },
