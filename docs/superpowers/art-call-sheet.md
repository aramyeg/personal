...
| `ch4-aureole` | `ch4-aureole` | Gilded guilloché vault-ring arc (dress on the hero's right panel, behind the head): engine-turned gilt, pierced filigree, pale rim edge | ≈1.13:1 near-square | FLAT | **art** (procedural) |
| `ch4-coins` | `ch4-coins` | Gold coins spilling off the dragon's own fold | ≈1.0:1 square | STAND — **ROTATED 180** | **art** |
| `ch4-chest` | `ch4-chest-front`, `ch4-chest-back`, `ch4-chest-side` (**no `-top`** — `roof:'open'`, hollow, no lid) | Open treasure chest — hollow box, reading camera looks straight down into a raw-paper interior; only 3 exterior faces need art | side ≈1.0:1 · front/back ≈2.0:1 | FACE | **art** (procedural) |
